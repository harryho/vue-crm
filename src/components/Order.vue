      ...
      <v-card class="grey lighten-4 elevation-0">
        ...
        <v-card-text>
          <v-container fluid>
            <v-layout row wrap>
              <v-flex md4 xs12>
                <v-text-field name="reference" label="Reference" hint="Reference is required" value="Input text" v-model="order.reference" class="input-group--focused" required></v-text-field>
              </v-flex>
  
              <v-flex md4 xs12>
                <v-text-field name="Amount" prefix="AUD $" label="Price" hint="Price is required" value="Input text" v-model="order.amount" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
                <v-text-field name="quantity" label="Product Items" hint="Number between 1 to 100" v-model="order.products.length" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
              ...
              <v-flex md4 xs12>
                <v-menu lazy :close-on-content-click="false" v-model="shippedDateMenu" transition="v-scale-transition" offset-y full-width :nudge-left="40" max-width="290px">
              ...
              <v-flex md4 xs12>
                <v-text-field name="address" label="Address" hint="Address is required" value="Input text" v-model="order.shipAddress.address" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
                <v-text-field name="city" label="City" hint="City is required" value="Input text" v-model="order.shipAddress.city" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
                <v-text-field name="zipcode" label="Zip Code" hint="Zip Code is required" value="Input text" v-model="order.shipAddress.zipcode" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
                <v-text-field name="country" label="Country" hint="Country is required" value="Input text" v-model="order.shipAddress.country" class="input-group--focused" required></v-text-field>
              </v-flex>
