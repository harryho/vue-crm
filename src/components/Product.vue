      ...
      <v-card class="grey lighten-4 elevation-0">
        ...
        <v-card-text>
          <v-container fluid>
            <v-layout row wrap>
              <v-flex md4 xs12>
                <v-text-field name="productName" label="Product" hint="Product name is required" value="Input text" v-model="product.productName" class="input-group--focused" required></v-text-field>
              </v-flex>
  
              <v-flex md4 xs12>
                <v-text-field name="unitPrice"  prefix="AUD $" label="Price" hint="Price is required" value="Input text" v-model="product.unitPrice" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
                <v-text-field name="unitInStock" label="Quantity" hint="Number between 1 to 100" v-model="product.unitInStock" class="input-group--focused" required></v-text-field>
              </v-flex>
              <v-flex md4 xs12>
